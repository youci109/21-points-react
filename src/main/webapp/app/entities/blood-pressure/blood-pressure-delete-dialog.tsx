...
export class BloodPressureDeleteDialog extends React.Component<IBloodPressureDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.bloodPressureEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="twentyOnePointsReactApp.bloodPressure.delete.question">
          <Translate contentKey="twentyOnePointsReactApp.bloodPressure.delete.question" interpolate={{ id: bloodPressureEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-bloodPressure" color="danger" onClick={this.confirmDelete}>
