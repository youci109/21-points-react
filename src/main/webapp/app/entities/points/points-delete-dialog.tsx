  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="twentyOnePointsReactApp.points.delete.question">
          <Translate contentKey="twentyOnePointsReactApp.points.delete.question" interpolate={{ id: pointsEntity.id }}>
